        ...
        <div className="max-w-6xl mx-auto px-4 pb-6 md:pb-12 relative z-10">
          <div className="flex flex-col items-start mb-8 md:mb-10">
            ...
            <p className="text-sm md:text-base text-light-blue text-center md:text-left mb-3">
              Rooted in Spain&apos;s winemaking heritage, we craft premium
              sparkling grape juice that turns everyday moments into
              celebrations—honoring the past, celebrating the present, and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 text-left">
            <div className="border-l-2 border-rose text-rose pl-4">
              ...
              <p className="text-sm md:text-base">
                Our drinks are made to elevate life&apos;s moments, turning
                everyday gatherings into unforgettable occasions.
              </p>
            </div>
            <div className="border-l-2 border-rose text-rose pl-4">
              <h3 className="text-xl sm:text-2xl md:text-4xl font-fisterra mb-2">
              ...
              <p className="text-sm md:text-base">
                From vineyard to bottle, we uphold the highest standards to
                deliver a premium sparkling grape juice.
              </p>
            </div>
            <div className="border-l-2 border-white-grape text-white-grape pl-4">
              ...
              <p className="text-sm md:text-base">
                Born from generations of farmers, we carry forward their
                relentless work ethic, perseverance, and determination in every
                bottle to meet you at the milestones you&apos;re chasing.
              </p>
            </div>
            <div className="border-l-2 border-white-grape text-white-grape pl-4">
              <h3 className="text-xl sm:text-2xl md:text-4xl font-fisterra mb-2">
              ...
              <p className="text-sm md:text-base">
                We believe tradition connects us to the moments and values that
                matter most. In every bottle, we honor the rituals of gathering,
                celebrating, and creating memories that stand the test of time.
              </p>
            </div>
      ...
      <section className="w-full bg-white-grape-light py-8 md:py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-fisterra text-3xl sm:text-4xl md:text-5xl text-blue mb-4 md:mb-4">
            A SPARKLING LEGACY FROM SPAIN
          </h2>
          <p className="text-light-blue mb-2 text-sm md:text-base">
            Every summer for over 20 years, our family has returned to
            Spain—drawn to the warmth of our heritage and the simple joys of
            time spent together. Our mother&apos;s hometown, La Alberca de
            Záncara in Castilla-La Mancha, welcomed us with family meals,
            afternoon siestas, and the timeless rhythm of life in the
            countryside.
          </p>
          <p className="text-light-blue mb-2 text-sm md:text-base">
            It was during one of these summers that we discovered <em>mosto</em>
            —a naturally sweet, sparkling grape juice made fresh at the local
            winery. Its vibrant flavor and purity instantly transported us,
            connecting us to something deeper: our roots, and the memory of our
            beloved grandfather, Nemesio.
          </p>
          <p className="text-light-blue mb-2 text-sm md:text-base">
            Born in 1933 in La Alberca de Záncara, Abuelo Nemesio was a farmer
            devoted to his vineyards and family. Though he wasn&apos;t much of a
            wine drinker, he cherished mosto—sharing it with loved ones during
            the grape harvest, a time of unity and gratitude. His values of hard
            work, togetherness, and love for the land inspire everything we do.
          </p>
          <p className="text-light-blue mb-8 text-sm md:text-base">
            Fuentelo&apos;s is our tribute to him. We craft our sparkling grape
            juices from the very grapes he once tended—Airén and Tempranillo
            varieties grown in La Mancha. More than a beverage, Fuentelo&apos;s
            is a celebration of legacy, family, and the joyful spirit of Spanish
            life.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center gap-8">
          <div className="flex-1">
            <h2 className="font-fisterra text-3xl sm:text-4xl md:text-5xl text-blue mb-4">
              THE ESSENCE OF CASTILLA-LA MANCHA IN EVERY SIP
            </h2>
            <p className="text-light-blue text-sm md:text-base">
              Experience the essence of Castilla-La Mancha with every sip of
              Fuentelo&apos;s Sparkling Grape Juice — a region where
              sun-drenched vineyards stretch across the Spanish horizon and
              tradition runs deep in the soil. Crafted from hand-selected grapes
              grown in this historic heartland, each bottle captures the vibrant
              spirit, natural sweetness, and refined character of the land.
              It&apos;s more than a drink — it&apos;s a celebration of culture,
              heritage, and the rich terroir of La Mancha in sparkling form.
            </p>
          </div>
